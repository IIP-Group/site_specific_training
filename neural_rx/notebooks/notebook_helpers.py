"""Presentation and path helpers for the site-specific training tutorial."""
...
class NotebookHelpers:
    ...
    def config_value(self, path, config_key):
        """Read one Python-literal value from a receiver configuration file."""
    ...
    def show_config(self, path):
        ...
        resolved_path = self.resolve(path)
        relevant_keys = ("label =", "channel_type =", "datalake_tf_fn", "max_num_tx")
