...
# weight_saving_schedule = [int(x) for x in [1e2, 5e2, 1e3, 5e3, 9e3, 1e4, 2e4, 5e4, 9e4, 1e5, 2e5, 3e5, 4e5, 5e5, 6e5, 7e5, 8e5, 9e5, 1e6]]
weight_saving_schedule = None
...
training_loop(sys_training,
            ...
            weight_saving_schedule=weight_saving_schedule,
